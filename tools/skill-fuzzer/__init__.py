...
try:
    from .fuzzer import STRATEGIES, FuzzResult, LLMClient, SkillFuzzer, load_seeds
except ImportError:
    from fuzzer import STRATEGIES, FuzzResult, LLMClient, SkillFuzzer, load_seeds  # type: ignore
