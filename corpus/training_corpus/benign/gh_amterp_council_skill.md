...
version: "1.0"
description: Participate in Council multi-agent collaboration sessions. Use when asked to join a council session, collaborate with...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: amterp/council
# corpus-url: https://github.com/amterp/council/blob/HEAD/internal/cli/skill.md
