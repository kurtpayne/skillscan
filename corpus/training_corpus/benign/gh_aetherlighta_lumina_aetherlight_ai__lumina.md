...
name: initialize
version: "1.0"
description: Initialize ÆtherLight in a new repository. Sets up folder structure, Git workflow, configuration files, and developme...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AEtherlight-ai/lumina
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AEtherlight-ai__lumina__claude__skills__initialize__SKILL.md
