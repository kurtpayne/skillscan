...
version: "1.0"
description: complete workflow to create talking character videos with lipsync and captions. use when creating ai character videos...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: vargHQ/sdk
# corpus-url: https://github.com/vargHQ/sdk/blob/HEAD/pipeline/cookbooks/SKILL.md
