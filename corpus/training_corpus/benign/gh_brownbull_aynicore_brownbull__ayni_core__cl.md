...
version: "1.0"
description: Coordinates backend development tasks (APIs, services, databases). Use when implementing REST APIs, business logic, d...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: Brownbull/ayni_core
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/Brownbull__ayni_core__claude__skills__backend-orchestrator__SKILL.md
