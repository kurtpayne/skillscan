...
name: docs-validator
version: "1.0"
description: Documentation quality validator for Logseq Template Graph. Checks documentation completeness, accuracy, formatting, l...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: C0ntr0lledCha0s/logseq-template-graph
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/C0ntr0lledCha0s__logseq-template-graph__claude__skills__docs-validator__SKILL.md
