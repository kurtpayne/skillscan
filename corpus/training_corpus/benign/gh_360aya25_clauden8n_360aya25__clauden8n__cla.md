...
version: "1.0"
description: Write JavaScript code in n8n Code nodes. Use when writing JavaScript in n8n, using $input/$json/$node syntax, making ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: 360AYA25/ClaudeN8N
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/360AYA25__ClaudeN8N__claude__skills__n8n-code-javascript__SKILL.md
