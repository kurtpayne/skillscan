...
name: obsidian-query
version: "1.0"
description: Query Obsidian vault using local HTTP API. Use when user asks about tasks, goals, experiments, journals, people, or a...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: ArtemXTech/obsidian-bases-demo
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/ArtemXTech__obsidian-bases-demo__claude__skills__obsidian-query__SKILL.md
