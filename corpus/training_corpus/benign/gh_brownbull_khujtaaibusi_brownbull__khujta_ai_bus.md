...
name: human-docs
version: "1.0"
description: Creates human-friendly documentation from AI context documentation. Transforms detailed AI documentation in ai/ folde...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: Brownbull/khujta_ai_business
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/Brownbull__khujta_ai_business__claude__skills__human-docs__SKILL.md
