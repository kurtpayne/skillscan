...
version: "1.0"
description: Best practices for handling Gemini API rate limits, implementing sequential queues, and preventing 429 RESOURCE_EXHAU...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: BerryKuipers/claude-code-toolkit
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/BerryKuipers__claude-code-toolkit__claude__skills__gemini-api__rate-limiting__SKILL.md
