...
version: "1.0"
description: Master Cohere v2 Chat API with Python, specializing in entity extraction using JSON Schema mode for structured output...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: ActiveInferenceInstitute/Journal-Utilities
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/ActiveInferenceInstitute__Journal-Utilities__claude__skills__cohere-v2-python__SKILL.md
