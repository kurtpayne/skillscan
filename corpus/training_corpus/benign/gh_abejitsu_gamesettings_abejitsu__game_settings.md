...
version: "1.0"
description: Use AI to recreate PDF page as semantic HTML. Consumes three inputs (PNG image, parsed text, ASCII preview) for compl...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AbeJitsu/Game-Settings-Panel
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AbeJitsu__Game-Settings-Panel__claude__skills__calypso__ai-html-generate__SKILL.md
