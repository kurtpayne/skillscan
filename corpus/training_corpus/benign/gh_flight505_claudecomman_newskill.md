...
name: newskill
version: "1.0"
description: Community skill from flight505/ClaudeCommands
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: flight505/ClaudeCommands
# corpus-url: https://github.com/flight505/ClaudeCommands/blob/HEAD/tools/newskill.md
