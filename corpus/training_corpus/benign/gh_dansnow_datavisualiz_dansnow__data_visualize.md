...
version: "1.0"
description: Interactive data exploration and visualization skill. Use when users ask to visualize data, analyze datasets, create ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: DanSnow/data-visualize
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/DanSnow__data-visualize__claude__skills__data-viz-insight__SKILL.md
