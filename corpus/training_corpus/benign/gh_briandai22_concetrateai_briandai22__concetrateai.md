...
version: "1.0"
description: Comprehensive backend development guide for Node.js/Express/TypeScript microservices. Use when creating routes, contr...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: BrianDai22/concetrateaiquiz
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/BrianDai22__concetrateaiquiz__claude__skills__backend-dev-guidelines__SKILL.md
