...
version: "1.0"
description: Token-efficient context gathering and synthesis from multiple sources (memory, docs, web). Orchestrates MCP tools to ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: 1ambda/dataops-platform
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/1ambda__dataops-platform__claude__skills__context-synthesis__SKILL.md
