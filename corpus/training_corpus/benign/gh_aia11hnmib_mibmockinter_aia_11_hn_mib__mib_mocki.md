...
name: cloudflare-r2
version: "1.0"
description: Guide for implementing Cloudflare R2 - S3-compatible object storage with zero egress fees. Use when implementing file...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AIA-11-HN-MIB/MIB-MockInterviewAIBot
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AIA-11-HN-MIB__MIB-MockInterviewAIBot__claude__skills__cloudflare-r2__SKILL.md
