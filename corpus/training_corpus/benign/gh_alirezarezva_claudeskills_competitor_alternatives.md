...
version: "1.0"
description: "When the user wants to create competitor comparison or alternative pages for SEO and sales enablement. Also use when th
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: alirezarezvani/claude-skills
# corpus-url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/.gemini/skills/competitor-alternatives/SKILL.md
