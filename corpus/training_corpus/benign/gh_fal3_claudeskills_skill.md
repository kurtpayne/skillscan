...
version: "1.0"
description: Strategies for developing apps that work across multiple Apple platforms, including adaptive layouts and multi-view i...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: fal3/claude-skills-collection
# corpus-url: https://github.com/fal3/claude-skills-collection/blob/HEAD/skills/cross-platform-app-development-skill/SKILL.md
