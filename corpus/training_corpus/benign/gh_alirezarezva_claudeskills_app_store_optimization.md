...
version: "1.0"
description: App Store Optimization (ASO) toolkit for researching keywords, analyzing competitor rankings, generating metadata sugges
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: alirezarezvani/claude-skills
# corpus-url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/.gemini/skills/app-store-optimization/SKILL.md
