...
version: "1.0"
description: Analyze job postings for requirements, culture, and values - outputs structured analysis matching lexicon categories ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AJBcoding/claude-skill-eval
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AJBcoding__claude-skill-eval__claude__skills__job-description-analysis__SKILL.md
