...
name: Skills Guide
version: "1.0"
description: Package expertise into discoverable, reusable capabilities that extend Claude's functionality. Use when creating new ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: CaptainCrouton89/.claude
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/CaptainCrouton89__.claude__claude__skills__skills-guide__SKILL.md
