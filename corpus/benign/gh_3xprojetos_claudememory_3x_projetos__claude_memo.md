...
name: scientist
version: "1.0"
description: Universal scientific thinking framework for rigorous inquiry across all domains - from engineering and data analysis ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: 3x-Projetos/claude-memory-framework
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/3x-Projetos__claude-memory-framework__claude__skills__scientist__SKILL.md
