...
name: skill-creator
version: "1.0"
description: [Utility] Guide for creating effective skills. This skill should be used when users want to create a new skill (or up...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: CANTAGESTUDIO/CosmicAtlasPacker
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/CANTAGESTUDIO__CosmicAtlasPacker__claude__skills__skill-creator__SKILL.md
