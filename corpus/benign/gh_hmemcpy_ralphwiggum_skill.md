...
name: ralph
version: "1.0"
description: Interactive planning skill for Amp. Generates specs, implementation plans, and loop infrastructure through clarifying...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: hmemcpy/ralph-wiggum
# corpus-url: https://github.com/hmemcpy/ralph-wiggum/blob/HEAD/agents/ralph/SKILL.md
