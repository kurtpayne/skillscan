...
version: "1.0"
description: Next.js 15 애플리케이션을 위한 프론트엔드 개발 가이드라인. React 19, TypeScript, Shadcn/ui, Tailwind CSS를 사용한 모던 패턴. Server Components, Cl...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: 0Chan-smc/claude-code-workflow-lab
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/0Chan-smc__claude-code-workflow-lab__claude__skills__frontend-dev-guidelines__SKILL.md
