...
version: "1.0"
description: Use this skill whenever the user wants to set up, refactor, or maintain a GitHub Actions CI/CD pipeline for deploying...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AgentiveCity/SkillFactory
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AgentiveCity__SkillFactory__claude__skills__cloudflare-ci-cd-github-actions__SKILL.md
