...
name: deep-thinker
version: "1.0"
description: Structured reasoning for complex problems using Sequential Thinking MCP. Break down problems into stages, track thoug...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AlexBaum-ai/NEURM
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AlexBaum-ai__NEURM__claude__skills__deep-thinker__SKILL.md
