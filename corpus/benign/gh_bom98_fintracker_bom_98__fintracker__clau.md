...
name: skill-creator
version: "1.0"
description: Guide for creating effective skills. This skill should be used when users want to create a new skill (or update an ex...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: BOM-98/FinTracker
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/BOM-98__FinTracker__claude__skills__skill-creator__SKILL.md
