...
version: "1.0"
description: Advanced coverage analysis with actionable insights. Use to identify coverage gaps, suggest specific tests, track cov...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: Atyantik/python-modern-template
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/Atyantik__python-modern-template__claude__skills__coverage-analyzer__SKILL.md
