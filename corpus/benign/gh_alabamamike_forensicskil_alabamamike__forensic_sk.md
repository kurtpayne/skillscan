...
version: "1.0"
description: Use when planning architecture refactoring, understanding cross-module dependencies, discovering hidden dependencies,...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AlabamaMike/forensic-skills
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AlabamaMike__forensic-skills__claude__skills__forensic-change-coupling__SKILL.md
