...
version: "1.0"
description: Manage Cloudflare R2 object storage for file hosting using Wrangler CLI. Use when uploading files to R2, managing buc...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: CaptainCrouton89/mystica-express
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/CaptainCrouton89__mystica-express__claude__skills__wrangler-r2__SKILL.md
