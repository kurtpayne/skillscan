...
name: git-analysis
version: "1.0"
description: Analyze git repository changes, branch differences, and commit history. Use when analyzing branches, comparing change...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: 1natsu172/dotfiles
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/1natsu172__dotfiles__claude__skills__git-analysis__SKILL.md
