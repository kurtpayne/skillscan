...
name: capture-screen
version: "1.0"
description: Programmatic screenshot capture on macOS. Find window IDs with Swift CGWindowListCopyWindowInfo, control application ...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: daymade/claude-code-skills
# corpus-url: https://github.com/daymade/claude-code-skills/blob/HEAD/capture-screen/SKILL.md
