...
name: prompting
version: "1.0"
description: Prompt engineering standards and context engineering principles for AI agents based on Anthropic best practices. Cove...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: AaronAbuUsama/alpha-arena
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/AaronAbuUsama__alpha-arena__claude__skills__prompting__SKILL.md
