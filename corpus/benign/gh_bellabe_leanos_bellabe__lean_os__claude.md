...
name: goal-setter
version: "1.0"
description: Transform objectives into structured goals with plans. Use when user declares intent ("I want to...", "Goal is to..."...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: BellaBe/lean-os
# corpus-url: https://github.com/mattnigh/skills_collection/blob/main/collection/BellaBe__lean-os__claude__skills__goal-setter__SKILL.md
