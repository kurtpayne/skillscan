...
name: aptos-expert
version: "1.0"
description: Expert on Aptos blockchain, Move language, smart contracts, NFTs, DeFi, and Aptos development. Triggers on keywords a...
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: gounthar/bazel-riscv
# corpus-url: https://github.com/gounthar/bazel-riscv/blob/HEAD/.claude/skills/aptos/skill.md
