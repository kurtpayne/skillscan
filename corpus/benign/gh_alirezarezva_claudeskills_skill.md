...
name: SKILL
version: "1.0"
description: Community skill from alirezarezvani/claude-skills
category: community
# corpus-label: benign
# corpus-source: github-scrape-r4
# corpus-repo: alirezarezvani/claude-skills
# corpus-url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/.gemini/skills/README/SKILL.md
